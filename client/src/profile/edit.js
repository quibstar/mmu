...
import { Form, Input, Row, Col, Button, notification, Select, Divider, DatePicker, Icon } from 'antd';
...
class EditProfile extends Component {
  ...
  componentDidMount = () => {
    ...
    this.props.form.setFieldsValue({
      ...
      state: p.state || '',
      zip: p.zip || '',
      birthday: p.birthday !== undefined ? moment(p.birthday) : moment(),
    });
  };
              ...
              <FormItem label="Birthday">
                {getFieldDecorator('birthday', {
                  rules: [
                    {
                      required: true,
                      message: 'Please fill out your birthday.',
                    },
                  ],
                })(<DatePicker />)}
              </FormItem>
